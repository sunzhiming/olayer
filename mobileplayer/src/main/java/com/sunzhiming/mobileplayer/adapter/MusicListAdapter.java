...
import com.sunzhiming.mobileplayer.bean.MusicInfo;
...
public class MusicListAdapter extends CursorAdapter {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        holder.mTitle.setText("暂未开放");
        holder.mSize.setText(Formatter.formatFileSize(context,musicInfo.size));
        holder.mTime.setText(Utils.formatDuration(musicInfo.time));
